...
| オリジナルアプリ開発後の発信・運営フローが分からない        | 知見・資本のある「法人」からアプローチをかけるというフローを構築
| 世に発信できるほどのクオリティである自信がない             | 他のユーザーの投稿を閲覧できないよう設計 |
| 企業サイドが掲載した案件に対し応募というフローではなく企業サイドからのアプローチによる確度の高い交渉をしたい | 新規チャットルーム作成は企業側のみ可能

### 企業視点
|            ユーザーストーリーから考える課題             |                      解決策                      |
| 自社サービスを改善するために必要なものを取り入れたい        | ITエンジニアのアイデア
| 新規事業を立ち上げたい                                 | 
| エンジニアの作品を見た上でをダイレクトリクルーティングしたい | 投稿検索
