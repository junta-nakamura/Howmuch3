...
| 成約の確度が低いことに時間をかけたくない                  | 新規チャットルーム作成は企業側のみ可能なため、DMが送付された場合のみ対応 |

### 企業視点
|            ユーザーストーリーから考える課題             |                      解決策                      |
| -------------------------------------------------- | ----------------------------------------------- |
| 自社サービスを改善するために必要なものを取り入れたい        | 開発言語やビジネスモデルを指定した検索が可能 |
| エンジニアの作品を見た上でをダイレクトリクルーティングしたい | 検索機能においてユーザーとポートフォリオの２種類で検索が可能 |
